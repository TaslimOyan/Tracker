...
<input type="submit" value="Search" class="btn btn-success"/>
    ...
    while($res=mysqli_fetch_array($rs_result)) {
		...
		echo "<td><a href=./".$res['file_link']." target='_blank'><span class='glyphicon glyphicon-paperclip'></span></a> | <a href=\"delete.php?id=$res[id]\" onClick=\"return confirm('Are you sure you want to delete?')\"><span class='glyphicon glyphicon-remove-circle'></span></a> | <a href=\"update.php?id=$res[id]\"><span class='glyphicon glyphicon-remove-circle'></span></a></td>";
    }
